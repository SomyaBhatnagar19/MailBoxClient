  ...
  async (_, thunkAPI) => {
    ...
    try {
      const response = await fetch(
        `https://mailboxclient-b4491-default-rtdb.firebaseio.com/emails/${currentUserName}.json`
      );
...
export const fetchSentMessages = createAsyncThunk(
  ...
  async (userName, thunkAPI) => {
    try {
      const response = await fetch(
        `https://mailboxclient-b4491-default-rtdb.firebaseio.com/sent/${userName}.json`
      );
      if (!response.ok) {
...
export const fetchDraftMessages = createAsyncThunk(
  ...
  async (userName, thunkAPI) => {
    try {
      const response = await fetch(
        `https://mailboxclient-b4491-default-rtdb.firebaseio.com/drafts/${userName}.json`
      );
      if (!response.ok) {
